...
public class Tour {
    ...
    public Tour(String name, String about, Date startDate, Date endDate, String departureLocation, String destinationLocation, String comment) {
        this.name = name;
        this.about = about;
        this.startDate = startDate;
        this.endDate = endDate;
